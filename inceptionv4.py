# 大部分的CNN模型可以通过torchvision框架直接调用，且模型都是在ImageNet数据集上预训练的，详见 https://pytorch.org/docs/stable/torchvision/models.html.
# inception_v4没有在torchvision中找到, 同时也可以通过本人fork的一个仓库(link如下)中找到常见的CNN模型代码，下面的代码也是从中复制的.
# https://github.com/ahtwq/pretrained-models.pytorch/edit/master/pretrainedmodels/models/inceptionv4.py
